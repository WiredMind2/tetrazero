			...
			<section className="section-2">
				<div data-animation="default" data-collapse="medium" data-duration="400" data-easing="ease" data-easing2="ease"
					...
					<div className="container-2 w-container">
						...
						<nav role="navigation" className="nav-menu w-nav-menu"><a href="/about"
							className="nav-link w-nav-link">About</a><a href="https://manga.tetrazero.com"
								className="nav-link w-nav-link">MANGAS</a>
							<div className="div-block-13"><a href="#" className="nav-link fake-link w-nav-link">Click me!</a>
